...
\item Définitions de l'espace dans les différentes pratiques.
 ...
 \begin{itemize}
  ...
  \item Audio spatialisé   % TODO historique
...
Par exemple il est souvent nécessaire d'ajuster les paramètres de spatialisation quand on change l'endroit ou se déroule une représentation. %TODO trouver source.
...
% NOTE: état de l'art intéressant au début.
...
% TODO \subsection{Autres approches}
% TODO - Génération d'espace à partir de description textuelle.
% TODO \cite{andriamarozakaniaina_du_2012} 

% TODO - Conception de mappings en trois dimensions dans Max/MSP. 
% TODO Mappings de régions de l'espace via interpolation :
% TODO  le mapping a lieu entre N dimensions de contrôle et M dimensions sonores.
% TODO \cite{van_nort_lom_2006}

 % TODO - Zones ? logiciels de 3d paramétrique, etc. 
...
% TODO - Quadtrees : \cite{eppstein_skip_2008}

% TODO - Approches géométriques.
...
% TODO - Description de formes : \cite{clementini_global_1997}.

% TODO - Modèles de contraintes : SketchPad.
...
% TODO - Modèle d'automates spatio-temporels adaptés à la gestion de systèmes de transports % TODO bof....
% TODO \cite{zhang_timed_2014}
...
% TODO Approches langage : (pour reconnaissance : \cite{spranger_recruitment_2011}\cite{spranger_emergent_2012}, )

% TODO \subsection{Problèmes géométriques et calculatoires}
% TODO - citer bibliothèques utiles.
\newpage
\printbibliography
\end{document}